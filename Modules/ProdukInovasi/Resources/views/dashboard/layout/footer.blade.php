    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="text-light mb-2"><i class="fa fa-map-marker-alt me-3"></i>Jl. Lohbener Lama No.08, Legok, Kec. Lohbener, Kabupaten Indramayu</p>
                {{-- <p class="text-light mb-2"><i class="fa fa-phone-alt me-3"></i>+012 345 67890</p> --}}
