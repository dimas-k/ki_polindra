...
<head>
    ...
    <title>Admin D-PROIN | Edit Berita</title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <h4 class="mb-4"><i class='bx bxs-news me-2'></i>Edit Berita</h4>
                            ...
                            <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text" id="judul" name="judul"
                                            ...
                                            value="{{ old('judul', $news->judul) }}" placeholder="Judul berita">
                                        @error('judul')
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        @if ($news->gambar_sampul)
                                            <div class="mb-2">
                                                <img src="{{ asset('storage/' . $news->gambar_sampul) }}"
                                                    alt="{{ $news->judul }}" style="max-width:200px;border-radius:6px;">
                                                <div class="form-text">Gambar sampul saat ini. Upload file baru untuk menggantinya.</div>
                                            </div>
                                        @endif
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        <textarea id="ringkasan" name="ringkasan" rows="3"
                                            ...
                                            placeholder="Muncul di daftar berita, maksimal 500 karakter">{{ old('ringkasan', $news->ringkasan) }}</textarea>
                                        @error('ringkasan')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-12">
                                        ...
                                        <textarea id="editor" name="konten" rows="10">{{ old('konten', $news->konten) }}</textarea>
                                        @error('konten')
