...
class AdminPatenController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kekayaanintelektual::admin.adminpaten.index', compact('paten', 'pf', 'mt', 'mp', 'mps', 'staw', 'stl', 'stak', 'mts', 'beri', 'tolak', 'mvdov'));
    }
    ...
    public function pemeriksaanFormalitas()
    {
        ...
        return view('kekayaanintelektual::admin.adminpaten.admin-paten-pf.index', compact('cek'));
    }

    public function menungguTanggapan()
    {
        $cek = Paten::latest()->where('status', 'Menunggu Tanggapan Formalitas')->get();
        return view('kekayaanintelektual::admin.adminpaten.admin-paten-mt.index', compact('cek'));
    }

    public function masaPengumuman()
    {
        $cek = Paten::latest()->where('status', 'Masa Pengumuman')->get();
        return view('kekayaanintelektual::admin.adminpaten.admin-paten-mp.index', compact('cek'));
    }

    public function pembayaranSubstansif()
    {
        $cek = Paten::latest()->where('status', 'Menunggu Pembayaran Substansif')->get();
        return view('kekayaanintelektual::admin.adminpaten.admin-paten-mps.index', compact('cek'));
    }

    public function substansifAwal()
    {
        $cek = Paten::latest()->where('status', 'Substansif Tahap Awal')->get();
        return view('kekayaanintelektual::admin.adminpaten.admin-paten-staw.index', compact('cek'));
    }

    public function substansifLanjut()
    {
        $cek = Paten::latest()->where('status', 'Substansif Tahap Lanjut')->get();
        return view('kekayaanintelektual::admin.adminpaten.admin-paten-stl.index', compact('cek'));
    }
    public function substansifAkhir()
    {
        $cek = Paten::latest()->where('status', 'Substansif Tahap Akhir')->get();
        return view('kekayaanintelektual::admin.adminpaten.admin-paten-stak.index', compact('cek'));
    }
    public function mengungguTanggapanSubstansif()
    {
        $cek = Paten::latest()->where('status', 'Menunggu Tanggapan Substansif')->get();
        return view('kekayaanintelektual::admin.adminpaten.admin-paten-mts.index', compact('cek'));
    }
    public function diberi()
    {
        $cek = Paten::latest()->where('status', 'Diberi')->get();
        return view('kekayaanintelektual::admin.adminpaten.admin-paten-beri.index', compact('cek'));
    }
    public function ditolak()
    {
        $cek = Paten::latest()->where('status', 'Ditolak')->get();
        return view('kekayaanintelektual::admin.adminpaten.admin-paten-tlk.index', compact('cek'));
    }
    public function mvdov()
    {
        $cek = Paten::latest()->where('status', 'Menunggu Verifikasi Data Oleh Verifikator')->paginate(5);
        return view('kekayaanintelektual::admin.adminpaten.admin-paten-mvdov.index', compact('cek'));
    }
    ...
    public function tambahPatenDosen()
    {
        $users = DB::table('users')
            ...
            ->get();
        // dd($users);
        return view('kekayaanintelektual::admin.adminpaten.tambah.dosen', compact('users'));
    }
    public function tambahPatenUmum()
    {
        $users = DB::table('users')
            ...
            ->Where('role', '=', 'Umum')
            ->get();
        return view('kekayaanintelektual::admin.adminpaten.tambah.umum', compact('users'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('kekayaanintelektual::admin.adminpaten.showpaten.index', compact('p'));
    }
    ...
    public function edit(string $id)
    {
        ...
        if ($p->institusi === 'Dosen') {
            return view('kekayaanintelektual::admin.adminpaten.editpaten.index', compact('p'));
        } else if ($p->institusi === 'Umum') {
            return view('kekayaanintelektual::admin.adminpaten.editpaten.umum', compact('p'));
        }
    }
