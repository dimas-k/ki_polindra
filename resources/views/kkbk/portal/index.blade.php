        ...
        <div class="row g-4">
            <div class="col-md-6 col-lg-4">
                <div class="portal-card p-4">
                    ...
                    <p class="text-muted mb-4">Pengajuan Paten, Hak Cipta, dan Desain Industri sebagai Dosen</p>
                    <a href="/dosen/dashboard" class="btn btn-outline-primary w-100">Masuk</a>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="portal-card p-4">
                    ...
                    <p class="text-muted mb-4">Dashboard Ketua KBK untuk kelola Produk Inovasi dan Penelitian</p>
                    <a href="/k-kbk/dashboard" class="btn btn-outline-primary w-100">Masuk</a>
                </div>
            </div>
        </div>
    </div>
